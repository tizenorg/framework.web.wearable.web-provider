...
char* web_provider_livebox_get_box_type(const char* box_id)
{
    if (!box_id) {
        return NULL;
    }
...
char* web_provider_livebox_get_app_id(const char* box_id)
{
    if (!box_id) {
        return NULL;
    }
...
bool web_provider_livebox_get_pd_fast_open(const char* box_id)
{
    if (!box_id) {
        return 0;
    }
...
bool web_provider_livebox_check_box_installed(const char* box_id)
{
    if (!box_id) {
        return 0;
    }
